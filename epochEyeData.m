...
for pp      = [1:10];
    ...
    values2use  = [31:39, 310:316]; % cue onset
    prestim     = -0.75; % 
    ...
    for task = [1:2];
        ...
        if task == 1
            task_ext = 'a';
            data = param.auditory_eye;
        elseif task == 2
            task_ext = 'v';
            data = param.visual_eye;
        end
        ...
        save([param.path, '\epoched_data\eyedata_m6', '__', param.subjName, '_', task_ext], 'eyedata');
